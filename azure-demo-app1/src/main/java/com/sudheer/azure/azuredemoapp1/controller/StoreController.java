package com.sudheer.azure.azuredemoapp1.controller;
...
import com.sudheer.azure.azuredemoapp1.service.StoresService;
...
public class StoreController {
    ...
    public ResponseEntity<List<StoresEntity>> getStores() {
        telemetryClient.trackEvent("app1-get-stores");
    ...
    public ResponseEntity<StoresEntity> getStore(@PathVariable("id") final Integer id) {
        telemetryClient.trackEvent("app1-get-store for id");
        if (id != null) {
            try {
    ...
    public ResponseEntity<String> addStore(@RequestBody final StoresBean storesBean) {
        telemetryClient.trackEvent("app1-add-store");
        if (storesBean != null) {
            try {
    ...
    public ResponseEntity<String> deleteStore(@PathVariable("id") final Integer id) {
        telemetryClient.trackEvent("app1-delete-store for id");
        if (id != null) {
            try {
    ...
    public ResponseEntity<String> updateStore(@RequestBody final StoresBean storesBean) {
        telemetryClient.trackEvent("aap1-update-store");
        if (storesBean != null) {
            try {
